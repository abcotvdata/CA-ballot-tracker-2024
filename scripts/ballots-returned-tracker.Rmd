...
row_with_names <- as.numeric(which(grepl("COUNTY", ballots$`45594.074317129627`))) #which row has the actual column names
...
ballots_clean <- ballots %>% 
  ...
  mutate(`% VBM returned` = round(((`VBM ballots returned`/`VBM Ballots issued`)*100), digits=2)) %>%  #percent that have been returned
  mutate(`% VBM accepted` = round(((`VBM Ballots accepted`/`VBM Ballots issued`)*100), digits=2))
...
<br>
<br>
<div class="footer">Built and designed by Lindsey Feingold and Jill Castellano. Source: <a href="https://www.sos.ca.gov/elections/upcoming-elections/general-election-nov-8-2022" target="_blank">California Secretary of State</a>. Data usually lags by about a day.</div>
